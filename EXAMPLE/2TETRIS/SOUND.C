...
void bgm_enqueue_main(void)
{
	...
	bl_snd_bgm_enqueue(0, "s2 v14 t80l16o4>erc-cde32d32c<bara>cerdcc-r8cdrercr<arar4>drfargfer8cef32e32dcc-r8cdn56en56cr");
	...
	bl_snd_bgm_enqueue(1, "s2 v14 t80l16o4brg+abb+32b32ag+e8eab+rbag+eg+ab8b+8a8e8eo2ab>cd>frab+rbagr8egrfeg+eg+abrb+rarere4br");
	...
	bl_snd_bgm_enqueue(2, "s2 v13 t80l16o2e>e<e>e<e>e<e>e<a>a<a>a<a>a<a>an32g+n32g+<e>e<e>e<a>a<a>a<a>ac-cd<drdrd32d32agc");
